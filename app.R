  ...
  tabPanel("Help & Guide",
    fluidPage(
      div(style = "padding: 30px;",
        ...
        tags$ul(
  tags$ul(
  tags$li(tags$a(href = "Alpha lattice_sample.csv", "📥 Alpha Lattice Sample CSV", target = "_blank")),
  tags$li(tags$a(href = "Augmented RCBD_Sample.csv", "📥 Augmented RCBD Sample CSV", target = "_blank")),
  tags$li(tags$a(href = "Diallel_Griffing Method1_Sample.csv", "📥 Griffing Method I Diallel Sample CSV", target = "_blank")),
  tags$li(tags$a(href = "Diallel_Griffing Method2_Sample.csv", "📥 Griffing Method II Diallel Sample CSV", target = "_blank")),
  tags$li(tags$a(href = "Diallel_Griffing Method3_Sample.csv", "📥 Griffing Method III Diallel Sample CSV", target = "_blank")),
  tags$li(tags$a(href = "Diallel_Griffing Method4_Sample.csv", "📥 Griffing Method IV Diallel Sample CSV", target = "_blank")),
  tags$li(tags$a(href = "Factorial_CRD_sample.csv", "📥 Factorial CRD Sample CSV", target = "_blank")),
  tags$li(tags$a(href = "Line x tester_Sample.csv", "📥 Line × Tester Sample CSV", target = "_blank")),
